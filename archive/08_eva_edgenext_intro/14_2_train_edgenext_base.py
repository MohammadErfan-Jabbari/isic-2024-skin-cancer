"""
Step 14.2: EdgeNeXt Base Training Script (384px)
...
for the EdgeNeXt Hybrid Model.

Usage:
    python 14_2_train_edgenext_base.py --fold 1 --gpu 0
"""
...
def parse_args():
    ...
    parser.add_argument('--batch-size', type=int, default=48, help='Batch size (EdgeNeXt is efficient)')
...
def train_fold(fold_num, gpu_id, args):
    ...
    if args.experiment_name:
        ...
        results_dir = Path(f"results/edgenext_base_384_{timestamp}")
